...
def create_iso_file_handler(
    ...
    path = f"{os.getcwd()}//app//app//services//utility//iso_keyword//static//iso_bulksheet.xlsx"
...
def download_iso_template():
    path = (
        f"{os.getcwd()}//app//app//services//utility//iso_keyword//static//iso_template.xlsx"
    )
    return FileResponse(path, headers={"Content-Type": "multipart/form-data"})
